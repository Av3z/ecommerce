...
class LoginContainer extends StatelessWidget {
  ...
  LoginContainer({super.key, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const Logo(),
        // textfield username
        CustomTextfield(hintText: 'Usuário', controller: _emailInputController),
        const SizedBox(
          height: 10,
        ),
        // textfield password
        ...
        SecondaryButton(text: 'Entrar', onTap: signUserIn),
